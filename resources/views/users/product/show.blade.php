    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="mb-4">
                        <img class="img-fluid w-100 rounded" src="{{ asset('storage/' . $product->image) }}"
                ...
                <div class="col-lg-5">
                    ...
                    {{-- Section Info Merchant --}}
                    @if ($product->owner && $product->owner->merchant)
                        <div class="merchant-info mt-5 p-4 bg-light rounded">
                            <div class="d-flex align-items-center mb-3">
                                <h4 class="mb-0 me-2">{{ $product->owner->merchant->nama_toko }}</h4>
                                {{-- Asumsi ada kolom is_verified di tabel merchants --}}
                                @if ($product->owner->merchant->is_verified)
                                    {{-- Menggunakan icon Font Awesome untuk badge --}}
                        ...
                        <div class="review-list">
                            ...
                            <div class="review-item d-flex">
                                ...
                                <div class="w-100">
                                    ...
                                    <p>Produknya bagus sekali! Tanaman saya jadi lebih subur setelah pakai pupuk ini.
                                        Pengiriman juga cepat. Sangat direkomendasikan!</p>
                                </div>
                            </div>
                            {{-- Contoh Ulasan 2 --}}
                            <div class="review-item d-flex">
                                ...
                                <div class="w-100">
                                    ...
                                    <p>Kualitasnya oke, tapi kemasannya sedikit sobek saat diterima. Mungkin bisa diperbaiki
                                        lagi untuk packingnya. Selebihnya memuaskan.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="{{ route('product.show', $similar->id) }}" class="product-card-link">
                                <div class="product-card">
                                    <img class="product-card-img" src="{{ asset('storage/' . $similar->image) }}"
                                        alt="{{ $similar->name }}">
                                    <div class="product-card-body">
                                        <h5 class="product-card-title">{{ $similar->name }}</h5>
                                        <h4 class="product-card-price">Rp
                                            {{ number_format($similar->price, 0, ',', '.') }}</h4>
                                    </div>
                                </div>
                            </a>
                        </div>
