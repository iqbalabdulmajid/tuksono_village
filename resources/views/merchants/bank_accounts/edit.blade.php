            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10 ms-1">Edit Rekening Bank</h5>
                    </div>
                    <ul class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5>Form Edit Rekening Bank</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('merchant.bank-accounts.update', $bankAccount->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
